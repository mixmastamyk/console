...
.. raw:: html
    ...
    <s><span style="opacity: .9">crap-ton,</span></s>
    err…
    <i>lot more!</i>  Kindly read on.</p>
...
(The underscores in the attribute names are optional.
...
:mod:`console.detection`:
    ...
    - Legacy Windows routines are in :mod:`console.windows`
